...
{
    public static void DirectionalDeathParticle(final Vector2 position, final Vector2 initVel, final RigidBody other, final Color color, final int count){
	...
	for(int i = 0; i < count; i++){
	    ...
	    Vector2 vel = Util.getBounceVelocity(pos, other.getTransform().getPosition(), initVel, other.getVelocity(), 1f, 20f);

	    vel.scl((float)Math.random()*800f + 200f);
