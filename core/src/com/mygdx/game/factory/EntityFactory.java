...
public class EntityFactory
{
	...
	entity.addComponent(new RigidBody(entity, 5f, 0.008f, 0f));
	...
	Entity entity = new Entity(world, transform);
	entity.addComponent(new RigidBody(entity, 1f, 0.008f, 0f));
	...
	Entity entity = new Entity(world, transform);
	entity.addComponent(new RigidBody(entity, 0.1f, 0f, 0f));
